    ...
    <section id="top" className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 pt-32 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-primary text-primary-foreground text-sm font-medium mb-8 shadow-glow">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-primary bg-clip-text text-transparent">Vibe LLM</span> - Use Claude Code 
            at <span className="bg-gradient-primary bg-clip-text text-transparent">30%</span> the Cost
          </h1>
          
          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Get Claude-level performance for 50-70% less. Perfect for developers and startups who need enterprise-grade AI without the enterprise price tag.
          </p>
          ...
          <p className="text-muted-foreground mt-6">
            🎉 <span className="text-primary font-semibold">$3 free credit</span> for new users - no strings attached
          </p>
        </div>
      </div>
      <SignupForm 
